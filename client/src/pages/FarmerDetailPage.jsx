...
const FarmerDetailPage = () => {
  ...
  const { farmerProfile, reviews, loading } = useSelector((state) => state.farmers);
  ...
  const handleSubmitReview = (e) => {
    ...
    dispatch(addReview({ farmerId: id, rating, comment }));
    setComment("");
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="glass p-6 rounded-xl mb-8">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/4 mb-6 md:mb-0 flex justify-center flex-col items-center">
            <div className="w-32 h-32 bg-green-100 rounded-full flex items-center justify-center mb-4 overflow-hidden">
              ...
              <div key={review._id} className="border-b border-gray-100 pb-4 last:border-0">
                <div className="flex justify-between items-start mb-2">
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center mr-3 text-green-700 font-bold text-xs">
                      {review.user?.name?.substring(0, 2).toUpperCase() || 'user'}
                    </div>
                    <div>
