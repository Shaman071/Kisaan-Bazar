              ...
              <div className="space-y-4 border-t border-gray-200 pt-4 mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      id="docType"
                      name="verificationDetails.documentType"
                      value={formData.verificationDetails?.documentType || "RTC"}
                      onChange={handleChange}
                      className="form-input"
                    >
                  ...
                  <div>
                    ...
                    <input
                      id="docNumber"
                      name="verificationDetails.documentNumber"
                      type="text"
                      value={formData.verificationDetails?.documentNumber || ""}
                      onChange={handleChange}
                      className="form-input"
                      placeholder="Details/ID Number"
                      required={formData.role === "farmer"}
                    />
                  </div>
                </div>
