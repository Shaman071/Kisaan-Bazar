...
import { getAllUsers, deleteUser, verifyFarmer } from "../../redux/slices/userSlice"
import Loader from "../../components/Loader"
import { FaSearch, FaUserEdit, FaTrash, FaEnvelope, FaPhone, FaMapMarkerAlt, FaCheckCircle, FaUserCheck } from "react-icons/fa"
                    ...
                    <tr className="hover:bg-gray-50">
                        ...
                        <div className="flex items-center">
                          ...
                          <div>
                            <div className="font-medium text-gray-900 flex items-center">
                              {user.name}
                              {user.role === 'farmer' && user.profile?.isVerified && (
                                <FaCheckCircle className="ml-1 text-green-500 text-xs" title="Verified Farmer" />
                              )}
                            </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div className="flex justify-end space-x-2">
                          ...
                          {user.role === "farmer" && (
                            <button
                              onClick={() => dispatch(verifyFarmer(user._id))}
                              className={`${user.profile?.isVerified ? "text-orange-500 hover:text-orange-700" : "text-green-600 hover:text-green-900"}`}
                              title={user.profile?.isVerified ? "Unverify Farmer" : "Verify Farmer"}
                            >
                              {user.profile?.isVerified ? <FaUserCheck /> : <FaCheckCircle className="text-gray-400 hover:text-green-500" />}
                            </button>
                          )}
                        </div>
                      </td>
