    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="glass p-6 rounded-xl mb-8">
        ...
        {farmerOrders.length > 0 ? (
                ...
                {Object.values(
                  farmerOrders
                    ...
                    .reduce((acc, item) => {
                      ...
                      acc[item.product._id].units += item.quantity;
                  ...
                  .map((product) => (
                    <tr key={product.id} className="border-b border-gray-200">
                      ...
                      <td className="text-center py-3 font-medium">{product.units}</td>
                      <td className="text-right py-3 font-medium">₨{product.revenue.toFixed(2)}</td>
                    </tr>
                  ))}
              </tbody>
            </table>
          ...
          <p className="text-gray-600 text-center py-4">No sales data yet.</p>
        )}
      </div>
