  ...
  useEffect(() => {
    if (product) {
      setFormData({
        ...
        bulkDiscount: {
          threshold: product.bulkDiscount?.threshold || "",
      ...
      <div className="glass p-6 rounded-xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-6">
            <h3 className="text-lg font-medium mb-3">Bulk Discount (Optional)</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label
                  htmlFor="bulkThreshold"
                  className="block text-sm font-medium text-gray-700 mb-1"
                >
                ...
                <input
                  type="number"
                  id="bulkThreshold"
                  name="bulkDiscount.threshold"
                  value={formData.bulkDiscount?.threshold || ""}
                  onChange={handleChange}
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Qty required to trigger discount
                </p>
              </div>
              <div>
                <label
                ...
                <input
                  type="number"
                  id="discountPercent"
                  name="bulkDiscount.discountPercent"
                  value={formData.bulkDiscount?.discountPercent || ""}
                  onChange={handleChange}
                  className="form-input pl-3"
                  min="0"
                  max="100"
